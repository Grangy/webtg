  ...
  return (
    <div className="animate-in fade-in duration-300">
      ...
      <button
        ...
        className="w-full p-3 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 hover:border-blue-500/50 text-blue-400 font-medium rounded-xl transition-all active:scale-[0.98] flex items-center justify-center gap-2 mb-2"
      >
      ...
      <button
        onClick={() => {
          if (typeof window !== "undefined") {
            const groupUrl = "https://t.me/vpnmax_off";
            if (window.Telegram?.WebApp?.openTelegramLink) {
              window.Telegram.WebApp.openTelegramLink(groupUrl);
            } else if (window.Telegram?.WebApp?.openLink) {
              window.Telegram.WebApp.openLink(groupUrl, { try_instant_view: false });
            } else {
        ...
        className="w-full p-2.5 bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/30 hover:border-purple-500/50 text-purple-400 font-medium text-sm rounded-xl transition-all active:scale-[0.98] flex items-center justify-center gap-2 mb-3"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
        </svg>
        <span>Информационная группа</span>
      </button>
