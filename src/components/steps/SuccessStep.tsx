...
export function SuccessStep({
  ...
  // Show SetupWizard first, then show success details after completion
  if (showSetupWizard) {
    return (
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden">
      ...
      <div className="text-center mb-4">
        ...
        <h1 className="text-lg font-bold text-white mb-1">Подписка активирована!</h1>
        <p className="text-zinc-400 text-xs">VPN готов к использованию</p>
      </div>
      ...
      <div className="space-y-2 mb-3">
        ...
        <button
          onClick={() => onCopyUrl(formatHappLink(subscription.subscriptionUrl))}
        ...
        >
          ...
          <span>Скопировать ссылку Happ</span>
        </button>
