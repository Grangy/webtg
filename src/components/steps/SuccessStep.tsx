    ...
    <div className="w-full max-w-full overflow-x-hidden">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-zinc-400 text-xs">
          {isRenewal ? "Ваша подписка успешно продлена" : "Подключение готово к использованию"}
        </p>
      </div>
        ...
        {subscription.subscriptionUrl2 && (
          <div className="p-2.5 border-b border-zinc-800/50">
            <div className="flex items-center gap-1.5 mb-1.5">
              ...
              <span className="text-zinc-400 text-[10px] font-medium">Сервер 2 (Миранда, иногда МТС)</span>
            </div>
            <div className="flex gap-1.5 items-start">
              <div className="flex-1 min-w-0">
                <div className="bg-zinc-900/50 border border-zinc-800/30 rounded-lg p-1.5 overflow-hidden">
